  ...
  return (
    <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#0B1120] to-[#0B1120] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
      ...
      <div className="flex flex-col gap-4">
        <h3 className="text-3xl font-bold text-white">Avinav Kashyap</h3>
        ...
        <p className="text-base text-gray-400 flex items-center gap-2">
          Email: <span className="text-lightText">avinav04kashyap@gmail.com</span>
        </p>
      </div>
      <div className="flex flex-col gap-4">
        ...
        <div className="flex gap-4">
          ...
          <a href="https://twitter.com/AvinavKashyap2" target="_blank">
            <span className="bannerIcon">
              <FaTwitter />
            </span>
          </a>
